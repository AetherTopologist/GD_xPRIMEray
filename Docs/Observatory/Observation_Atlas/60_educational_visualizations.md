...
|---|---|
| Direct measurement view | Encodes a declared measurement channel and units |
| Derived diagnostic | Applies a documented computation or transform to measurements |
| Conceptual diagram | Explains relationships without presenting measured output |
